...
class MyPageMenuUseTableViewCell: UITableViewCell {
    
    static let identifier = "MyPageMenuUseTableViewCell"
    ...
    func configureCell(_ useTitle : MenuUse) {
        titleLabel.text = useTitle.useTitle
    }
